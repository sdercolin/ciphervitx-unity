...
/// <summary>
/// (B01) B01-038 天馬三姉妹の長姉 パオラ
/// </summary>
public class Card00084 : Card
{
    public Card00084(User controller) : base(controller)
    {
        Serial = "00084";
        Pack = "B01";
        CardNum = "B01-038";
    ...
    public class Sk1 : AutoSkill
    {
        public Sk1() : base()
        {
            Number = 1;
            Name = "三角攻击";
            Description = "〖阵型技〗『三角攻击』【自】[将我方的「卡秋雅」和「爱丝特」转为已行动状态]这名单位攻击时，你可以支付费用。如果支付，则直到战斗结束为止，这名单位的战斗力+50，攻击不能被神速回避。";
            Optional = true;
        ...
        {
            return Cost.ActionOthers(this, 1, card => card.HasUnitNameOf(Strings.Get("card_text_unitname_カチュア"))) + Cost.ActionOthers(this, 1, card => card.HasUnitNameOf(Strings.Get("card_text_unitname_エスト")));
        }
    ...
    public class Sk2 : PermanentSkill
    {
        public Sk2() : base()
        {
            Number = 2;
            Name = "三姐妹的羁绊";
            Description = "『三姐妹的羁绊』【常】这名单位被「卡秋雅」或「爱丝特」支援的期间，这名单位的战斗力+10。";
        ...
        public override bool CanTarget(Card card)
        {
            return card == Owner
                ...
                && (card.Controller.Support.SupportedBy(Strings.Get("card_text_unitname_カチュア")) || card.Controller.Support.SupportedBy(Strings.Get("card_text_unitname_エスト")));
        }
